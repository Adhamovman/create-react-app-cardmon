...
import { faHouse, faPlus, faClipboard } from "@fortawesome/free-solid-svg-icons";
import { faHouse as farHouse, faClipboard as farClipboard } from "@fortawesome/free-regular-svg-icons";

const Footer = ({ handleShow, handleTab, active }) => {
    ...
    <footer className="px-2">
      <div className="menu-left">
        <button
          ...
          className="menu-btn btn btn-white"
          onClick={() => handleTab(1)}
        >
